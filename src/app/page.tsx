...
import { getFeaturedGames, getTrendingGames, getNewGames } from '@/data/games';
...
export const metadata: Metadata = {
  ...
  description: 'Discover and play thousands of free online games. From action and adventure to puzzle and strategy games, find your next favorite game on AwesomeCart Gaming.',
  keywords: [
    'free online games',
    'browser games',
    'action games',
  ...
  openGraph: {
    title: 'AwesomeCart Gaming - Play Free Online Games',
    description: 'Discover and play thousands of free online games. From action and adventure to puzzle and strategy games, find your next favorite game.',
    images: ['/og-home.jpg'],
  },
  twitter: {
    title: 'AwesomeCart Gaming - Play Free Online Games',
...
export default function HomePage() {
  ...
  debug('HomePage: Rendering home page component', { timestamp: new Date().toISOString() });
      ...
      <main className="flex-1">
        ...
        <section className="py-16 px-4 bg-gaming-pattern">
          <div className="container mx-auto">
            ...
            <Suspense fallback={<div className="text-center">Loading featured games...</div>}>
              <FeaturedGames />
            </Suspense>
          </div>
        </section>
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto">
            ...
            <Suspense fallback={<div className="text-center">Loading trending games...</div>}>
              <TrendingGames />
            </Suspense>
          </div>
        </section>
        ...
        <section className="py-16 px-4 bg-gaming-pattern">
          <div className="container mx-auto">
            ...
            <Suspense fallback={<div className="text-center">Loading new games...</div>}>
              <NewGames />
            </Suspense>
          </div>
        </section>
